...
This folder is the extension point for concise, human-facing Talos docs that
would bloat the root orientation files.

Current orientation starts here:

- [`../../README.md`](../../README.md) - project overview and runnable entrypoints
